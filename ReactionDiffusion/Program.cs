...
public static class Program
{
    ...
    {
        using (SixLabors.ImageSharp.Image<Rgb24> image = SixLabors.ImageSharp.Image.Load<Rgb24>("input.png"))
        {
